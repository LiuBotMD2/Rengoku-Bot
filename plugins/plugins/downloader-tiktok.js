...
let texto = `*[⏱️] @${m.sender.split`@`[0]} 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 𝚄𝙽 𝙼𝙾𝙼𝙴𝙽𝚃𝙾 𝙴𝙽 𝙻𝙾 𝚀𝚄𝙴 𝙴𝙽𝚅𝙸𝙾 𝚂𝚄 𝚅𝙸𝙳𝙴𝙾 𝙳𝙴 𝚃𝙸𝙺𝚃𝙾𝙺*`
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '_🔥𝗥𝗲𝗻𝗴𝗼𝗸𝘂_𝗕𝗼𝘁🔥_', body: null, thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/KN9i1Xyi68A7Z8DMLSsLFh' }, mentionedJid: [m.sender] }}}, { quoted: m })
...
conn.sendMessage(m.chat, { video: { url: data[data.length - 1] }, caption: '_🔥𝗥𝗲𝗻𝗴𝗼𝗸𝘂_𝗕𝗼𝘁🔥_', footer: await shortUrl(data[data.length - 1]), buttons }, { quoted: m })
} catch {
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '_🔥𝗥𝗲𝗻𝗴𝗼𝗸𝘂_𝗕𝗼𝘁🔥_', body: null, thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/KN9i1Xyi68A7Z8DMLSsLFh' }, mentionedJid: [m.sender] }}}, { quoted: m })
...
conn.sendMessage(m.chat, { video: { url: url}, caption: '_🔥𝗥𝗲𝗻𝗴𝗼𝗸𝘂_𝗕𝗼𝘁🔥_', footer: await shortUrl(url), buttons }, { quoted: m })
} catch {
